 ...
 */
export const STONE_HITBOXES: Record<number, { dx: number; dy: number; r: number }[]> = {
 ...
 */
export function getStoneWorldCircles(stone: StonePos): { cx: number; cy: number; r: number }[] {
