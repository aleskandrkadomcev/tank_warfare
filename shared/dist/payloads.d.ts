...
export type ClientChangeTeamMessage = {
    type: typeof ClientMsg.CHANGE_TEAM;
    team: number;
};
export type ClientToggleReadyMessage = {
    type: typeof ClientMsg.TOGGLE_READY;
};
export type ClientStartGameMessage = {
    type: typeof ClientMsg.START_GAME;
};
...
export type ClientBulletRemoveMessage = {
    type: typeof ClientMsg.BULLET_REMOVE;
    bulletId: string;
};
...
export type ClientDeathMessage = {
    type: typeof ClientMsg.DEATH;
};
export type ClientRestartMatchMessage = {
    type: typeof ClientMsg.RESTART_MATCH;
};
export type ClientDeployMineMessage = {
    type: typeof ClientMsg.DEPLOY_MINE;
    x: number;
    y: number;
};
export type ClientLaunchRocketMessage = {
    type: typeof ClientMsg.LAUNCH_ROCKET;
    tx: number;
    ty: number;
};
export type ClientCollisionDamageMessage = {
    type: typeof ClientMsg.COLLISION_DAMAGE;
    otherId: string;
};
...
export type ClientDeploySmokeMessage = {
    type: typeof ClientMsg.DEPLOY_SMOKE;
    x: number;
    y: number;
};
...
export type ClientInboundMessage = ClientCreateLobbyMessage | ClientJoinLobbyMessage | ClientUpdatePlayerMessage | ClientChangeTeamMessage | ClientToggleReadyMessage | ClientStartGameMessage | ClientBulletMessage | ClientBulletRemoveMessage | ClientDealDamageMessage | ClientStateMessage | ClientDeathMessage | ClientRestartMatchMessage | ClientDeployMineMessage | ClientLaunchRocketMessage | ClientCollisionDamageMessage | ClientBoostPickupMessage | ClientBricksDestroyBatchMessage | ClientDeploySmokeMessage | ClientAddBotMessage | ClientRemoveBotMessage;
export type ServerLobbyListMessage = {
    type: typeof ServerMsg.LOBBY_LIST;
...
export type ServerBulletRemoveMessage = {
    type: typeof ServerMsg.BULLET_REMOVE;
    bulletId: string;
};
...
export type ServerGameOverMessage = {
    type: typeof ServerMsg.GAME_OVER;
    winner: number;
};
export type ServerPlayerDiedMessage = {
    type: typeof ServerMsg.PLAYER_DIED;
    playerId: string;
};
export type ServerRestartMatchMessage = {
    type: typeof ServerMsg.RESTART_MATCH;
    map: MapPayload | null;
};
...
export type ServerCollisionHitMessage = {
    type: typeof ServerMsg.COLLISION_HIT;
    damage: number;
};
...
export type ServerScoreUpdateMessage = {
    type: typeof ServerMsg.SCORE_UPDATE;
    scores: Record<number, number>;
};
export type ServerMineTriggeredMessage = {
    type: typeof ServerMsg.MINE_TRIGGERED;
    mineId: string | number;
};
export type ServerMineRemovedMessage = {
    type: typeof ServerMsg.MINE_REMOVED;
    mineId: string | number;
};
/** Исходящие от сервера по игре / лобби (не исчерпывающий union редких вариантов). */
export type ServerOutboundGameMessage = ServerLobbyListMessage | ServerLobbyCreatedMessage | ServerLobbyJoinedMessage | ServerLobbyStateMessage | ServerErrorMessage | ServerStartMessage | ServerBulletBroadcast | ServerBulletRemoveMessage | ServerBulletHitMessage | ServerBulletHitVisualMessage | ServerStateBroadcast | ServerGameOverMessage | ServerPlayerDiedMessage | ServerRestartMatchMessage | ServerDeployMineBroadcast | ServerLaunchRocketBroadcast | ServerExplosionEventMessage | ServerExplosionDamageMessage | ServerCollisionHitMessage | ServerBoostPickupBroadcast | ServerBoostSpawnMessage | ServerBricksDestroyBatchBroadcast | ServerDeploySmokeBroadcast | ServerScoreUpdateMessage | ServerMineTriggeredMessage | ServerMineRemovedMessage;
